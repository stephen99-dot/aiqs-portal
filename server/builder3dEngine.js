...
function normaliseInputs(raw = {}) {
  ...
  return {
    ...
    rooflights: Math.round(clamp(raw.rooflights, 0, 20, 0)),
    wallType,
    roofCovering,
...
function buildRecipe(m, q) {
  ...
  return [
    ...
    { category: 'Roof', label: 'Roof windows (Velux)', code: 'CJ-024', descLike: 'roof window', unit: 'nr', qty: m.rooflights },
