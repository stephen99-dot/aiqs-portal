...
import { MessageCircle, X, Send, Phone, FileText, HelpCircle, Clock, ChevronRight, Zap } from 'lucide-react';

// ═══════════════════════════════════════════════════════════════════════════════
// WHATSAPP WIDGET — src/components/WhatsAppWidget.js
// Floating WhatsApp button with chat panel and quick actions
// ═══════════════════════════════════════════════════════════════════════════════
...
const QUICK_ACTIONS = [
  ...
  },
  {
    ...
    message: "Hi, could I get an update on my current project?",
    color: '#F59E0B',
  },
  {
    icon: Zap,
      ...
      {isOpen && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: '#FFF' }}>CRM Wizard AI</div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: '4px 0 0', fontSize: 11, color: isDark ? '#3B4D66' : '#94A3B8', textAlign: 'right' }}>
